...
const ELM={hi:['火','Fuego'],ts:['土','Tierra'],kz:['風','Viento'],mz:['水','Agua'],tg:['天','Cielo'],ym:['闇','Oscuridad'],kn:['金','Metal'],kr:['氷','Hielo'],ik:['雷','Rayo'],ar:['嵐','Tormenta'],mr:['森','Bosque'],yu:['夢','Sueño']};
const ELC={hi:'#c14b35',ts:'#a5713c',kz:'#6e8f5a',mz:'#3f7fa3',tg:'#c9a24b',ym:'#7d57a8',kn:'#8a8a8a',kr:'#7fb8c8',ik:'#f7d358',ar:'#5a6b7c',mr:'#4a7c59',yu:'#c9a0c9'};
...
const NAV=[
 ...
 ['cap14.html','獣','Bestiario'],
  ...
  ['cap19.html','火','Hi · Fuego'],
  ['cap20.html','土','Tsuchi · Tierra'],
  ['cap21.html','風','Kaze · Viento'],
  ['cap22.html','水','Mizu · Agua'],
  ['cap23.html','天','Tengoku · Cielo'],
  ['cap24.html','闇','Yami · Oscuridad']
];
